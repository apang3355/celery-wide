...
require (
	git.kxsz.net/gopkg/log v1.1.3 // indirect
	git.kxsz.net/gopkg/sso v0.0.0-20240105023909-f5acf941e277 // indirect
	...
	github.com/getsentry/sentry-go/otel v0.27.0 // indirect
